    ...
    <Stack flexDirection="column" alignItems="center" mt={15} mb={10} p={2}>
      ...
      <Grow in={true} timeout={3200}>
        ...
        >
          ...
          which is an area that I really like and was the reason why I started studying web development.
           Today I'm a Full Stack developer and I have some integrated projects, putting into practice all the knowledge acquired.`}
        </Typography>
      </Grow>
    </Stack>
  );
